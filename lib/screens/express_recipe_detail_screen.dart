...
/// Детальный экран одного рецепта «Диета быстрая».
class ExpressRecipeDetailScreen extends StatelessWidget {
  final ExpressRecipe recipe;

  const ExpressRecipeDetailScreen({super.key, required this.recipe});
