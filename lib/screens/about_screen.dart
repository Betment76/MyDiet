...
⚡ Диета быстрая — результат без лишней теории, поэтапно и по делу
🍽️ Диета вкусная — худейте вкусно, без жёстких запретов
🎮 Диета интересная — игровой формат и живые рецепты
💪 Диета мужская — с учётом мужского метаболизма и привычного рациона
🏆 Диета трудная — для серьёзной долгосрочной работы над весом

Каждая методика — 3 этапа с меню на каждый день.

Меню под вас:
• План на каждый день — не нужно думать «что приготовить»
• Запрещённые продукты — меню подстроится под аллергии и непереносимость
• Рецепты с фото — для методик «Вкусная» и «Интересная»
• Дневник питания — приёмы пищи, вода и прогулки в одном месте
• Улучшена работа уведомлений о воде

Спасибо, что выбрали «Мою диету»!
''';
