...
import 'package:my_diet/screens/fun_method_screen.dart';
import 'package:my_diet/screens/fun_recipes_screen.dart';
...
/// Экран «Худеем интересно» — этапы, совет дня, меню по дням.
class FunMethodologyScreen extends StatefulWidget {
  final VoidCallback? onBack;
  final bool isActiveView;

  const FunMethodologyScreen({
    super.key,
    this.onBack,
  ...
  @override
  State<FunMethodologyScreen> createState() =>
      _FunMethodologyScreenState();
}

class _FunMethodologyScreenState extends State<FunMethodologyScreen> {
  static const _methodologyId = MethodologyIds.fun;
  ...
  @override
  void didUpdateWidget(FunMethodologyScreen oldWidget) {
...
class _FunMethodologyBody extends StatelessWidget {
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const FunMethodScreen(),
                        ),
                      ),
                      child: Padding(
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const FunRecipesScreen(),
                        ),
                      ),
                      child: Padding(
                        padding: const EdgeInsets.all(16),
