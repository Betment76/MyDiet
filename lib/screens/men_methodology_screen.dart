...
import 'package:my_diet/screens/men_method_screen.dart';
import 'package:my_diet/screens/men_recipes_screen.dart';
...
/// Экран «Мужская диета» — этапы, совет дня, меню по дням.
class MenMethodologyScreen extends StatefulWidget {
  final VoidCallback? onBack;
  final bool isActiveView;

  const MenMethodologyScreen({
    super.key,
    this.onBack,
  ...
  @override
  State<MenMethodologyScreen> createState() =>
      _MenMethodologyScreenState();
}

class _MenMethodologyScreenState extends State<MenMethodologyScreen> {
  static const _methodologyId = MethodologyIds.men;
  ...
  @override
  void didUpdateWidget(MenMethodologyScreen oldWidget) {
...
class _MenMethodologyBody extends StatelessWidget {
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const MenMethodScreen(),
                        ),
                      ),
                      child: Padding(
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: InkWell(
                      onTap: () => Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (_) => const MenRecipesScreen(),
                        ),
                      ),
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    'Блюда для вечернего ужина по методике',
                                    style: theme.textTheme.bodySmall?.copyWith(
                                      color:
                                          theme.colorScheme.onSurfaceVariant,
                                    ),
